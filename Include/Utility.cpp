...
TCHAR *GetOsVersion()
{
	...
	{
		static TCHAR szOSVersion[128] = { 0 };
		//下面根据版本信息判断操作系统名称
		...
		case 4:
			...
			case 0:
				if (os.dwPlatformId == VER_PLATFORM_WIN32_NT)
					_tcscpy(szOSVersion, _T("Microsoft Windows NT 4.0"));//1996年7月发布 
				else if (os.dwPlatformId == VER_PLATFORM_WIN32_WINDOWS)
					_tcscpy(szOSVersion, _T("Microsoft Windows 95"));
				break;
			case 10:
				_tcscpy(szOSVersion, _T("Microsoft Windows 98"));
				break;
			case 90:
				_tcscpy(szOSVersion, _T("Microsoft Windows Me"));
				break;
			}
			break;
		case 5:
			...
			{
			case 0:
				_tcscpy(szOSVersion, _T("Microsoft Windows 2000"));		//1999年12月发布 
				break;
			case 1:
				_tcscpy(szOSVersion, _T("Microsoft Windows XP"));		//2001年8月发布 
				break;
			case 2:
				if (os.wProductType == VER_NT_WORKSTATION &&
					info.wProcessorArchitecture == PROCESSOR_ARCHITECTURE_AMD64)
					_tcscpy(szOSVersion, _T("Microsoft Windows XP Professional x64 Edition"));
				else if (GetSystemMetrics(SM_SERVERR2) == 0)
					_tcscpy(szOSVersion, _T("Microsoft Windows Server 2003")); //2003年3月发布 
				else if (GetSystemMetrics(SM_SERVERR2) != 0)
					_tcscpy(szOSVersion, _T("Microsoft Windows Server 2003 R2"));
				break;
			}
			break;
		case 6:
			...
			case 0:
				if (os.wProductType == VER_NT_WORKSTATION)/* VER_NT_WORKSTATION是桌面系统 */
					_tcscpy(szOSVersion, _T("Microsoft Windows Vista"));
				else
					_tcscpy(szOSVersion, _T("Microsoft Windows Server 2008"));          //服务器版本 
				break;
			case 1:
				if (os.wProductType == VER_NT_WORKSTATION)
					_tcscpy(szOSVersion, _T("Microsoft Windows 7"));
				else
					_tcscpy(szOSVersion, _T("Microsoft Windows Server 2008 R2"));
				break;
			}
			break;
		default:
			_tcscpy(szOSVersion, _T("Unknow OS"));
		}
		return szOSVersion;
	}
	else
